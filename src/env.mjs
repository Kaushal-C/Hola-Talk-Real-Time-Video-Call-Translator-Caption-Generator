...
//   MS_TRANSLATOR_KEY: z.string().min(1),
//   MS_TRANSLATOR_ENDPOINT: z.string().url(),
//   MS_TRANSLATOR_REGION: z.string().min(1),
// });
...
const processEnv = {
  ...
  // --- START OF THE FIX ---
  // Add the new Microsoft Translator variables here
  MS_TRANSLATOR_KEY: process.env.MS_TRANSLATOR_KEY,
  MS_TRANSLATOR_ENDPOINT: process.env.MS_TRANSLATOR_ENDPOINT,
  MS_TRANSLATOR_REGION: process.env.MS_TRANSLATOR_REGION,
  // --- END OF THE FIX ---
};
